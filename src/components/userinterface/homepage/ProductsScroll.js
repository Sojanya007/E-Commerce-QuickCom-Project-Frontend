        ...
        return data.map((item) => {
            ...
            return (
                <div style={{ display: 'flex', flexDirection: 'column' }}>
                    ...
                    <div onClick={() => handleNavigateProductDetail(item)} style={{ alignSelf: 'center' }}>
                    ...
                    {item.offerprice > 0 ? <div style={{ marginTop: 7, display: 'flex', flexDirection: 'column' }}>
                        ...
                        <div style={{
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', fontSize: 12 }}><s><span>&#8377;{item.price}</span></s><span style={{ margin: 5, width: 60, display: 'flex', justifyContent: 'center', alignItems: 'center', borderRadius: 2, background: '#e5f7ee', color: '#03753ce' }}>{op}% OFF</span></div>
                        </div>
    ...
    return (
        <div>
            ...
            <div style={{ position: 'relative' }}>
                ...
                {matches ? <div onClick={handleNext} style={{ top: '43%', left: '0.3%', zIndex: 2, position: 'absolute', background: '#b2bec3', opacity: 0.5, width: 30, height: 30, borderRadius: 15, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                ...
                {matches ? <div onClick={handlePrev} style={{ top: '43%', right: '1.9%', zIndex: 2, position: 'absolute', background: '#b2bec3', opacity: 0.5, width: 30, height: 30, borderRadius: 15, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
